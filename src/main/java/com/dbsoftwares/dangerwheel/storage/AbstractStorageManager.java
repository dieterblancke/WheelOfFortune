package com.dbsoftwares.dangerwheel.storage;

import com.dbsoftwares.dangerwheel.DangerWheel;
import com.dbsoftwares.dangerwheel.storage.managers.FileStorageManager;
import com.dbsoftwares.dangerwheel.storage.managers.H2StorageManager;
import com.dbsoftwares.dangerwheel.storage.managers.MySQLStorageManager;
import com.dbsoftwares.dangerwheel.storage.managers.SQLiteStorageManager;
...
public abstract class AbstractStorageManager {
    ...
    public void initializeStorage() throws Exception {
        ...
        try (InputStream is = DangerWheel.getInstance().getResource(type.getSchema())) {
            if (is == null) {
