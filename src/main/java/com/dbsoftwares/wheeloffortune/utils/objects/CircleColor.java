package com.dbsoftwares.wheeloffortune.utils.objects;
...
public enum CircleColor {
    ...
    public String getAsText() {
        return this.getChatColor().toString() + WheelOfFortune.getInstance().getConfiguration().getString("wheel.hologram.icon");
    }

    public Material getAsMaterial() {
        return Material.getMaterial(
                this.materialColorName + "_" + WheelOfFortune.getInstance().getConfiguration().getString("wheel.block.type")
        );
    }
}
